            ...
            <section class="page_inner">
                ...
                <header class="sub_header">
                    <div class="container p-lg-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <h3>All Protfolio Items</h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="add_items_btn">
                                    <a class="" href="protfolio-item-add.php">Add Item</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="items_lists">
                    <div class="container p-lg-0">
                        ...
                        <div class="list_body">
                            ...
                            <!-- row -->
                            <div class="row row_style">
                                <div class="col-lg-2 col_style">
                                    <div class="si_no">
                                        <h5>01</h5>
                                    </div>
                                </div>
                                <div class="col-lg-3 col_style">
                                    <div class="item_link">
                                        <a href="#">Item Link</a>
                                    </div>
                                </div>
