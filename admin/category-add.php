...
<body>
    ...
    <div class="page protfolio_items add category bg_cover" style="background:url(../images/admin_bg.jpg);">
        <div class="overlay">
            <!-- Header Top -->
            <header>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form action="save-item.php">
                                    <div class="form_group">
                                        ...
                                        <input type="category" id="" placeholder="Enter New Category">
                                    </div>
